...
static int cup_use_kmsdrm(void) {
  ...
  if (v && (!strcasecmp(v, "kmsdrm") || !strcasecmp(v, "sdl") ||
            !strcasecmp(v, "wayland") || !strcasecmp(v, "x11"))) {
    dec = 1; return dec;
  }
  if (v && (!strcasecmp(v, "fbdev") || !strcasecmp(v, "mali") ||
            !strcasecmp(v, "directfb") || !strcasecmp(v, "fbcon"))) {
    dec = 0; return dec;
  }
  ...
  if (!driver) {
    dec = 0;
  } else if (!strcasecmp(driver, "mali") || !strcasecmp(driver, "fbcon") ||
             !strcasecmp(driver, "directfb") || !strcasecmp(driver, "fbdev")) {
    dec = 0;
  } else {
    dec = 1;
  }
